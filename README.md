...
2. Configure ESP32 Gateway
   ...
   On Windows, make sure to run `idf.py` commands inside an ESP-IDF CLI environment (e.g., ESP-IDF PowerShell or CMD), otherwise `idf.py` will not be recognized. Also, make sure you are in the `esp32/ruuvitag_gateway` directory.
